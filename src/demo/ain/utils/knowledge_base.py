...
class KnowledgeBase:
    ...
    def populate_mock_data(self):
        ...
        # Define "Healthy" bounds for a potential healthcheck, similar to SLO's i think
        ...
        # Make it understand that these triggers are a sign of congestion? just for test for now...
        ...
        # Note this is an example of hashed steps, just recommendations, not an ordered list of procedures for the LLM
        # Maybe ordered is better? 
        ...
        for step in cong_steps:
            step_node = URIRef(self.NS[f"proc_{hash(step)}"])
